    ...
    <Box className={styles.container}>
      <Box className={styles.subcontainer}>
        ...
        <Typography sx={{ width: "100%" }}>
          CodeNinja delivers efficient and user-friendly applications for your
          business. Our team will help you in every step of this process from
        ...
        <Box className={styles.formSection}>
          ...
          <Box>
            <Link href="/contact/" className="btn btn-secondary" style={{padding:'10px 100px'}}>
              SEND
            </Link>
          </Box>
        </Box>
